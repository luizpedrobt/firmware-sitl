...
#define HAL_IO_ARRAY_SIZE(a) (sizeof(a) / sizeof(a[0]))
    ...
    */
    ...
    /**
      ...
      @param[in,out] pucPtr ponteiro para o buffer onde está o inteiro de 16 bits
      sem sinal a ser invertido
    */
    void utl_io_swap16p(uint8_t *pucPtr);

    /**
      Inverte um inteiro de 32 bits sem sinal dentro de um buffer.
      @param[in,out] pucPtr ponteiro para o buffer onde está o inteiro de 32 bits
      sem sinal a ser invertido
    */
    ...
    /**
      ...
      @param[in,out] ucChar ponteiro para o buffer onde está o byte cujos bits serão
      invertidos
    */
    ...
    */
    ...
    uint8_t utl_io_get8_fl_apr(uint8_t **buf);      /**< Pega um uint8_t usando little
                                                       endian e adiciona o ponteiro */
    uint8_t utl_io_get8_fb_apr(uint8_t **buf);      /**< Pega um uint8_t usando big
                                                       endian e adiciona o ponteiro */
...
#define utl_io_get8_fb_ap(x) utl_io_get8_fb_apr(&x) /**< Macro para facilitar @ref utl_io_get8_fb_apr */
    ...
    uint16_t utl_io_get16_fl_apr(uint8_t **buf); /**< Pega um uint16_t usando little
                                                    endian e adiciona o ponteiro */
    uint16_t utl_io_get16_fb_apr(uint8_t **buf); /**< Pega um uint16_t usando big
                                                    endian e adiciona o ponteiro */
#define utl_io_get16_fl_ap(x)                                                                                          \
    utl_io_get16_fl_apr(&x) /**< Macro para facilitar @ref utl_io_get16_fl_apr                                         \
                             */
#define utl_io_get16_fb_ap(x)                                                                                          \
    utl_io_get16_fb_apr(&x) /**< Macro para facilitar @ref utl_io_get16_fb_apr                                         \
                             */
    ...
    uint32_t utl_io_get32_fl_apr(uint8_t **buf); /**< Pega um uint32_t usando little
                                                    endian e adiciona o ponteiro */
    uint32_t utl_io_get32_fb_apr(uint8_t **buf); /**< Pega um uint32_t usando big
                                                    endian e adiciona o ponteiro */
#define utl_io_get32_fl_ap(x)                                                                                          \
    utl_io_get32_fl_apr(&x) /**< Macro para facilitar @ref utl_io_get32_fl_apr                                         \
                             */
#define utl_io_get32_fb_ap(x)                                                                                          \
    utl_io_get32_fb_apr(&x) /**< Macro para facilitar @ref utl_io_get32_fb_apr                                         \
                             */
    ...
    uint64_t utl_io_get64_fl_apr(uint8_t **buf); /**< Pega um uint64_t usando little
                                                    endian e adiciona o ponteiro */
    uint64_t utl_io_get64_fb_apr(uint8_t **buf); /**< Pega um uint64_t usando big
                                                    endian e adiciona o ponteiro */
#define utl_io_get64_fl_ap(x)                                                                                          \
    utl_io_get64_fl_apr(&x) /**< Macro para facilitar @ref utl_io_get64_fl_apr                                         \
                             */
#define utl_io_get64_fb_ap(x)                                                                                          \
    utl_io_get64_fb_apr(&x) /**< Macro para facilitar @ref utl_io_get64_fb_apr                                         \
                             */
    ...
    float utl_io_getf_fl_apr(uint8_t **src_ptr);    /**< Pega um float usando little
                                                       endian e adiciona o ponteiro */
    float utl_io_getf_fb_apr(uint8_t **src_ptr);    /**< Pega um float usando big
                                                       endian e adiciona o ponteiro */
...
#define utl_io_getf_fb_ap(x) utl_io_getf_fb_apr(&x) /**< Macro para facilitar @ref utl_io_getf_fb_apr */
    ...
    double utl_io_getd_fl_apr(uint8_t **src_ptr);   /**< Pega um double usando little
                                                       endian e adiciona o ponteiro */
    double utl_io_getd_fb_apr(uint8_t **src_ptr);   /**< Pega um double usando big
                                                       endian e adiciona o ponteiro */
...
#define utl_io_getd_fb_ap(x) utl_io_getd_fb_apr(&x) /**< Macro para facilitar @ref utl_io_getd_fb_apr */
    ...
    */
    ...
    void utl_io_put8_tl_apr(uint8_t value, uint8_t **buf); /**< Coloca um uint8_t usando little
                                                              endian e adiciona o ponteiro */
    void utl_io_put8_tb_apr(uint8_t value, uint8_t **buf); /**< Coloca um uint8_t usando big endian
                                                              e adiciona o ponteiro */
#define utl_io_put8_tl_ap(v, x)                                                                                        \
    utl_io_put8_tl_apr(v, &x) /**< Macro para facilitar @ref utl_io_put8_tl_apr                                        \
                               */
#define utl_io_put8_tb_ap(v, x)                                                                                        \
    utl_io_put8_tb_apr(v, &x) /**< Macro para facilitar @ref utl_io_put8_tb_apr                                        \
                               */
    ...
    void utl_io_put16_tl_apr(uint16_t value, uint8_t **buf); /**< Coloca um uint16_t usando little
                                                                endian e adiciona o ponteiro */
    void utl_io_put16_tb_apr(uint16_t value, uint8_t **buf); /**< Coloca um uint16_t usando big
                                                                endian e adiciona o ponteiro */
...
#define utl_io_put16_tb_ap(v, x) utl_io_put16_tb_apr(v, &x)  /**< Macro para facilitar @ref utl_io_put16_tb_apr */
    ...
    void utl_io_put32_tl_apr(uint32_t value, uint8_t **buf); /**< Coloca um uint32_t usando little
                                                                endian e adiciona o ponteiro */
    void utl_io_put32_tb_apr(uint32_t value, uint8_t **buf); /**< Coloca um uint32_t usando big
                                                                endian e adiciona o ponteiro */
...
#define utl_io_put32_tb_ap(v, x) utl_io_put32_tb_apr(v, &x)  /**< Macro para facilitar @ref utl_io_put32_tb_apr */
    ...
    void utl_io_put64_tl_apr(uint64_t value, uint8_t **buf); /**< Coloca um uint64_t usando little
                                                                endian e adiciona o ponteiro */
    void utl_io_put64_tb_apr(uint64_t value, uint8_t **buf); /**< Coloca um uint64_t usando big
                                                                endian e adiciona o ponteiro */
...
#define utl_io_put64_tb_ap(v, x) utl_io_put64_tb_apr(v, &x)  /**< Macro para facilitar @ref utl_io_put64_tb_apr */
    ...
    void utl_io_putf_tl_apr(float value, uint8_t **buf); /**< Coloca um float usando little
                                                            endian e adiciona o ponteiro */
    void utl_io_putf_tb_apr(float value, uint8_t **buf); /**< Coloca um float usando big endian e
                                                            adiciona o ponteiro */
#define utl_io_putf_tl_ap(v, x)                                                                                        \
    utl_io_putf_tl_apr(v, &x) /**< Macro para facilitar @ref utl_io_putf_tl_apr                                        \
                               */
#define utl_io_putf_tb_ap(v, x)                                                                                        \
    utl_io_putf_tb_apr(v, &x) /**< Macro para facilitar @ref utl_io_putf_tb_apr                                        \
                               */
    ...
    void utl_io_putd_tl_apr(double value, uint8_t **buf); /**< Coloca um double usando little
                                                             endian e adiciona o ponteiro */
    void utl_io_putd_tb_apr(double value, uint8_t **buf); /**< Coloca um double usando big endian
                                                             e adiciona o ponteiro */
#define utl_io_putd_tl_ap(v, x)                                                                                        \
    utl_io_putd_tl_apr(v, &x) /**< Macro para facilitar @ref utl_io_putd_tl_apr                                        \
                               */
#define utl_io_putd_tb_ap(v, x)                                                                                        \
    utl_io_putd_tb_apr(v, &x) /**< Macro para facilitar @ref utl_io_putd_tb_apr                                        \
                               */
